...
namespace vision {
    ...
    public:
         ...
         */
        inline void resize(std::size_t numFeatures) {
         ...
         */
        inline unsigned char* feature(std::size_t i) { return &mFeatures[i*mNumBytesPerFeature]; }
        inline const unsigned char* feature(std::size_t i) const { return &mFeatures[i*mNumBytesPerFeature]; }
         ...
         */
        inline FeaturePoint& point(std::size_t i) { return mPoints[i]; }
        inline const FeaturePoint& point(std::size_t i) const { return mPoints[i]; }
